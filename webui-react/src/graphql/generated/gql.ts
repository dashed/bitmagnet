 ...
 */
export function graphql(
  source: "query TorrentContentSearch($aggregationBudget: Float, $cached: Boolean, $facets: TorrentContentFacetsInput, $hasNextPage: Boolean, $infoHashes: [Hash20!], $limit: Int, $orderBy: [TorrentContentOrderByInput!], $page: Int, $queryString: String, $totalCount: Boolean) {\n  torrentContent {\n    search(\n      input: {aggregationBudget: $aggregationBudget, cached: $cached, facets: $facets, hasNextPage: $hasNextPage, infoHashes: $infoHashes, limit: $limit, orderBy: $orderBy, page: $page, queryString: $queryString, totalCount: $totalCount}\n    ) {\n      totalCount\n      totalCountIsEstimate\n      hasNextPage\n      items {\n        id\n        infoHash\n        title\n        contentType\n        seeders\n        leechers\n        dhtSeenCount\n        dhtFirstSeenAt\n        dhtLastSeenAt\n        publishedAt\n        torrent {\n          fileExtensions\n          filesCount\n          magnetUri\n          name\n          singleFile\n          size\n        }\n      }\n      aggregations {\n        contentType {\n          value\n          label\n          count\n          isEstimate\n        }\n        torrentSource {\n          value\n          label\n          count\n          isEstimate\n        }\n        torrentTag {\n          value\n          label\n          count\n          isEstimate\n        }\n        torrentFileType {\n          value\n          label\n          count\n          isEstimate\n        }\n        language {\n          value\n          label\n          count\n          isEstimate\n        }\n        genre {\n          value\n          label\n          count\n          isEstimate\n        }\n        releaseYear {\n          value\n          label\n          count\n          isEstimate\n        }\n        videoResolution {\n          value\n          label\n          count\n          isEstimate\n        }\n        videoSource {\n          value\n          label\n          count\n          isEstimate\n        }\n      }\n    }\n  }\n}",
