...
export class TorrentsSearchComponent implements OnInit, OnDestroy {
  ...
  // Flag to prevent circular updates between form and URL params
  ...
  ngOnInit(): void {
    this.subscriptions.push(
      ...
      // Don't automatically update on unit changes - only when Apply is clicked
      // This prevents updates while user is still selecting options
