const en = {
  ...
  fileSearch: {
    ...
    noExtension: "none",
    orderBy: "Order by",
    peerSummary: "{{seeders}} S / {{leechers}} L",
  ...
  savedSearches: {
    apply: "Apply saved search",
    cancel: "Cancel",
    confirm: "Save",
    delete: "Delete",
    deleteNamed: "Delete saved search {{name}}",
    empty: "No saved searches yet.",
    nameLabel: "Name",
    namePlaceholder: "Name this search",
    paletteHint: "Saved search",
    rename: "Rename",
    renameNamed: "Rename saved search {{name}}",
    save: "Save search",
    saved: "Search saved",
  ...
  search: {
    ...
    publishedCustomRange: "Custom range",
    ...
    publishedRangeEnd: "To",
    publishedRangeInvalid: "Start date must be on or before end date.",
    publishedRangeStart: "From",
    ...
    searchInsteadFor: "Search instead for “{{query}}”",
    seeders: "Seeders",
    size: "Size",
    sizeAtLeast: "≥ {{size}}",
    sizeAtMost: "≤ {{size}}",
