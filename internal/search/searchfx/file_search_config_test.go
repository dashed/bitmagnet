...
func TestFileSearchConfigDefaultsDisabled(t *testing.T) {
	...
	assert.True(t, c.FileSearchRouteText, "SEARCH_FILE_SEARCH_ROUTE_TEXT must default true")
}
...
func TestFileSearchEnvVarNames(t *testing.T) {
	...
	want := map[string]string{
		...
		"FileSearchRouteText": "SEARCH_FILE_SEARCH_ROUTE_TEXT",
	}
...
func TestFileSearchConfigMapsFields(t *testing.T) {
	...
	pc := c.composerConfig()
	assert.False(t, pc.FileSearchRouteText)
}
